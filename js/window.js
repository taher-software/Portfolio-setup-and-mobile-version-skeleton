...
function createMobileProjectCard (key){
    ...
    inf.innerHTML = projects[key].generalInf[0] + "  " + "&bullet" + ";" + "  " + projects[key].generalInf[1] + "  " + "&bull" + ";" + "  " + projects[key].generalInf[2];
    inf.classList.add("title");
   
    description.innerHTML = projects[key].description.substring(0,Math.max(130,Math.floor(0.4 * projects[key].description.length)));
    description.classList.add("project_description");
   
    projects[key].technolgies.forEach(element => {
        techns.innerHTML += "<li>" + element + "</li>";
